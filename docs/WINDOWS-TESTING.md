...
- [ ] Add `000001` and `SH000001` as China A-shares in one list; both save and show different prices (Ping An Bank and the SSE Composite), and their charts open SZSE:000001 and SSE:000001. The Watchlist hint below the table shows its whole example line in English and Chinese at the minimum window size.
